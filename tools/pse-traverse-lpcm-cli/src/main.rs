...
Primary invariant: Local51(U) => Candidate(U), Candidate(U) != Truth
  pse-traverse-lpcm doors     [--json]   the binary's docking surface, self-described
";
...
fn doors_catalog() -> DoorCatalog {
    ...
    DoorCatalog::new(vec![
        ...
        Door::new(
            ...
            "inspect",
            vec![],
            "inspect a phase-space window",
            vec![DoorInput::valued("window", "<json>").required()],
            DoorGovernance::ReadOnly,
            vec![DoorNeed::File],
        ),
        Door::new(
            ...
            "partition",
            vec![],
            "partition the window into fragments",
        ...
        Door::new(
            ...
            "collapse",
            vec![],
            "the 51-percent hierarchical condensation",
            vec![DoorInput::valued("window", "<json>").required(), DoorInput::valued("--rd", "<file>"), DoorInput::valued("--out", "<file>")],
            DoorGovernance::ReadOnly,
            vec![DoorNeed::File],
        ),
        Door::new(
            ...
            "replay",
            vec![],
            "replay a collapse report byte-identically",
            vec![DoorInput::valued("--rd", "<file>").required(), DoorInput::valued("--input", "<json>").required(), DoorInput::valued("--report", "<json>").required()],
            DoorGovernance::ReadOnly,
            vec![DoorNeed::File],
        ),
        Door::new(
...
fn cmd_doors(args: &[String]) {
    ...
    println!("pse-traverse-lpcm doors — the docking surface");
    println!(
        "  catalog {}… · {} door(s)",
