...
const USAGE: &str = "Usage:
  ...
  pse-traverse-horizon doors     [--json]   the binary's docking surface, self-described
";
...
fn doors_catalog() -> DoorCatalog {
    let here = || DoorSurface::Cli {
        binary: "pse-traverse-horizon".into(),
    };
    DoorCatalog::new(vec![
        Door::new(
            here(),
        ...
        Door::new(
            ...
            "chart",
            vec![],
            "compute the horizon chart (collapse/emission duality)",
        ...
        Door::new(
            ...
            "rays",
            vec![],
            "projection-cone rays for causal admissibility",
            vec![DoorInput::valued("input", "<json>").required(), DoorInput::valued("--rd", "<file>").required(), DoorInput::valued("--out", "<file>")],
            DoorGovernance::ReadOnly,
            vec![DoorNeed::File],
        ),
        ...
        Door::new(
            ...
            "finalize",
            vec![],
            "finalize the emission into a horizon certificate",
            vec![DoorInput::valued("input", "<json>").required(), DoorInput::valued("--rd", "<file>").required(), DoorInput::valued("--out", "<file>")],
            DoorGovernance::ReadOnly,
            vec![DoorNeed::File],
        ),
        Door::new(
            ...
            "replay",
            vec![],
            "replay a final/hold report byte-identically",
            vec![DoorInput::valued("input", "<json>").required()],
            DoorGovernance::ReadOnly,
            vec![DoorNeed::File],
        ),
        Door::new(
            ...
            "verify",
            vec![],
            "verify a horizon certificate",
            vec![DoorInput::valued("certificate", "<json>").required()],
            DoorGovernance::ReadOnly,
            vec![DoorNeed::File],
        ),
    ])
...
fn cmd_doors(args: &[String]) {
    ...
    println!("pse-traverse-horizon doors — the docking surface");
    println!(
        "  catalog {}… · {} door(s)",
