...
PHASEMATRIX-HIVEMIND-03 — morphodynamic resonance cell substrate (PhaseCells, ResonanceClusters, FunnelGraphs, ConvergenceFields, ADAMANT-conformant fail-closed gates, trace-preserving dissolution)

`phase-matrix` is part of the [Kosmocrates](https://github.com/lashsesh/pse) workspace —
...
API reference: `cargo doc -p phase-matrix --open`
(once published, also available on [docs.rs](https://docs.rs/phase-matrix)).
